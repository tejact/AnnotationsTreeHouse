...
public class DocProcessor {
    ...
    private static boolean hasReturnDescription(Method method, Doc doc) {
    	...
    	if (method.getReturnType().equals(Void.TYPE) || !doc.returnVal().isEmpty()) {
    		return true;
    	}
